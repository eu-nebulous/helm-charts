...
*/}}
{{- define "nebulous-gui-controller.name" -}}
...
*/}}
{{- define "nebulous-gui-controller.fullname" -}}
...
*/}}
{{- define "nebulous-gui-controller.chart" -}}
...
Common labels
*/}}
{{- define "nebulous-gui-controller.labels" -}}
helm.sh/chart: {{ include "nebulous-gui-controller.chart" . }}
{{ include "nebulous-gui-controller.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "nebulous-gui-controller.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "nebulous-gui-controller.fullname" .) .Values.serviceAccount.name }}
{{- else }}
